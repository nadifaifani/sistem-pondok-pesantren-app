                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tempat_lahir_pendaftar"
                                    name="tempat_lahir_pendaftar" placeholder="Masukkan Tempat Lahir">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_lahir_pendaftar"
                                    name="tanggal_lahir_pendaftar" placeholder="Masukkan Tanggal Lahir">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email_wali_pendaftar"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alamat_wali_pendaftar"
                                    name="alamat_wali_pendaftar" placeholder="Masukkan Alamat Wali">
                            </div>
                            <div class="mb-3">
                                <label for="ktp_pendaftar" class="form-label">KTP</label>
                                <input type="file" class="form-control" id="ktp_pendaftar" name="ktp_pendaftar"
                                    required>
                            </div>
                            <div class="mb-3">
