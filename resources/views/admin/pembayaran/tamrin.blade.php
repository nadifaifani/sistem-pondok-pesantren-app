                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive mb-3">
                                <table id="tableTamrinLunas" class="table" role="grid"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive mb-3">
                                <table id="tableTamrinBelumLunas" class="table" role="grid"
                                    aria-describedby="user-list-page-info" style="width: 100%; min-height: 500px;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var tabel_lunas = $('#tableTamrinLunas').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('tamrin') }}",
                ...
                initComplete: function() {
                    ...
                    $('<span class="ml-4"><label>Tahun: <select id="filterTahunLunas" class="form-control"><option value="">Semua Tahun</option></select></label></span>')
                        .appendTo('#tableTamrinLunas_filter');
            ...
            var tabel_belum_lunas = $('#tableTamrinBelumLunas').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('tamrin') }}",
                ...
                initComplete: function() {
                    ...
                    $('<span class="ml-4"><label>Tahun: <select id="filterTahunBelumLunas" class="form-control"><option value="">Semua Tahun</option></select></label></span>')
                        .appendTo('#tableTamrinBelumLunas_filter');
