            ...
            <div id="sidebar-scrollbar">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="@if (request()->routeIs('beranda')) active @endif">
                        ...
                        <li class="@if (request()->routeIs('daftar_ulang') || request()->routeIs('iuran_bulanan') || request()->routeIs('tamrin')) active @endif">
                            ...
                            <ul id="pembayaran" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class="@if (request()->routeIs('daftar_ulang')) active @endif"><a href="">Daftar Ulang</a></li>
                                <li class="@if (request()->routeIs('iuran_bulanan')) active @endif"><a href="">Iuran Bulanan</a></li>
                                <li class="@if (request()->routeIs('tamrin')) active @endif"><a href="">Tamrin</a></li>
                            </ul>
                        </li>
