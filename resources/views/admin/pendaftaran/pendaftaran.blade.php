                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive pb-3 pt-2 px-3">
                                <table id="tablePendaftaran" class="table" role="grid"
        ...
        $(document).ready(function() {
            $('#tablePendaftaran').DataTable({
                ...
                columns: [
                    ...
                    // Kolom TTL
                    {
                        data: 'tempat_tanggal_lahir_pendaftar',
                        name: 'tempat_tanggal_lahir_pendaftar',
                    },

                    // Kolom Jenis Kelamin
                    {
                        data: 'jenis_kelamin_pendaftar',
                        name: 'jenis_kelamin_pendaftar',
                        render: function(data, type, full, meta) {
                            switch (full.jenis_kelamin_pendaftar) {
                                case 'laki-laki':
                                    return '<span class="badge badge-pill badge-danger">Laki - laki</span>';
                                default:
